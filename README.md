...
> [!IMPORTANT] 
> **Disclaimer** (**Este disclaimer no fue escrito por una IA**)

El contenido de este documento no fue generado por una IA; yo seleccioné manualmente todo el software y las herramientas mencionadas, y la mayoría las utilizo con regularidad.
Solo la categorización del software y los títulos fueron creados por una IA.
El uso de íconos y emojis fue una elección personal.

Este archivo era originalmente un .txt en mi computadora; quería compartirlo de forma práctica y no quise dedicar tiempo a organizarlo ni a recrearlo en Markdown.

* **English**

> [!IMPORTANT] 
> **Disclaimer** (**This disclaimer was not written by an AI**)

The content of this document was not generated by an AI; I manually selected all the software and tools mentioned, and I regularly use most of them.
Only the software categorization and the headings were created by an AI.
The use of icons and emojis was a personal choice.

This file was originally a .txt on my computer; I wanted to share it conveniently and did not want to spend time organizing or recreating it in Markdown.
...
<ul>
  <li>
    <details open>
      ...
      <ul>
        <li>⚠️ <a href="#%EF%B8%8Fdisclaimer">Disclaimer</a></li>
